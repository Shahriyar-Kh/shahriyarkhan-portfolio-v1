...
# search engines actually crawl. The custom domain is the canonical
# public identity; preview hosts must never become sitemap canonicals.
PUBLIC_SITE_URL = os.getenv("PUBLIC_SITE_URL", "https://shahriyarkhan.com")
